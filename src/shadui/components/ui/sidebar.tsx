...
import { useIsMobile } from "@/shadui/hooks/use-mobile"
    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border bg-[#141621]"
        >
          {children}
        </div>
      </div>
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 h-16", className)}
      {...props}
    />
  )
}
